...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_admin_admin__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_admin_admin__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_profile_profile__ = __webpack_require__(113);
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen, authServiceProvider) {
        ...
        this.pages = [
            { title: 'Sign in', component: __WEBPACK_IMPORTED_MODULE_7__pages_login_login__["a" /* LoginPage */] },
            { title: 'Sign up', component: __WEBPACK_IMPORTED_MODULE_8__pages_signup_signup__["a" /* SignupPage */] },
            { title: 'Home', component: __WEBPACK_IMPORTED_MODULE_4__pages_home_home__["a" /* HomePage */] },
            { title: 'Profile Page', component: __WEBPACK_IMPORTED_MODULE_10__pages_profile_profile__["a" /* ProfilePage */] },
        ];
        var self = this;
        this.authServiceProvider.getUser().then(function (user) {
            if (user) {
                if (user.is_verified == 2 && user.user_type == 1) {
                    self.pages.push({ title: 'Admin', component: __WEBPACK_IMPORTED_MODULE_9__pages_admin_admin__["a" /* AdminPage */] });
                    self.pages.push({ title: 'Post Page', component: __WEBPACK_IMPORTED_MODULE_5__pages_post_post__["a" /* PostPage */] });
                    self.pages.push({ title: 'Post Page', component: __WEBPACK_IMPORTED_MODULE_5__pages_post_post__["a" /* PostPage */] });
                    self.pages.push({ title: 'Browse News', component: __WEBPACK_IMPORTED_MODULE_6__pages_post_post_list__["a" /* PostListPage */] });
                }
